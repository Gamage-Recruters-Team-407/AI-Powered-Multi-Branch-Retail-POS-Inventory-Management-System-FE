...
export default function UserListPage() {
  ...
  return (
    <div className="user-page-container">
      <style>{`
        .user-page-container { padding: 32px; max-width: 1200px; margin: 0 auto; box-sizing: border-box; }
        .user-header { display: flex; justify-content: space-between; align-items: center; margin-bottom: 32px; }
        .user-stats-grid { display: grid; grid-template-columns: 1fr auto auto auto; gap: 16px; align-items: center; margin-bottom: 24px; }
        .user-table-wrapper { background: rgba(255,255,255,0.85); backdrop-filter: blur(20px); border-radius: 20px; border: 1px solid rgba(255,255,255,0.7); box-shadow: 0 8px 32px rgba(0,0,0,0.08); overflow-x: auto; }
        .user-table { width: 100%; border-collapse: collapse; font-size: 14px; min-width: 800px; }
        .user-modal-content { background: rgba(255,255,255,0.98); border-radius: 24px; padding: 36px; width: 520px; max-width: 95vw; box-shadow: 0 25px 60px rgba(0,0,0,0.2); border: 1px solid rgba(255,255,255,0.8); box-sizing: border-box; }
        .user-modal-grid { display: grid; grid-template-columns: 1fr 1fr; gap: 18px; }
        
        @media (max-width: 768px) {
          .user-page-container { padding: 16px; }
          .user-header { flex-direction: column; align-items: flex-start; gap: 16px; }
          ...
          .user-modal-content { padding: 24px; }
        }
      `}</style>
      ...
      <div className="user-header">
        ...
        <button onClick={openAdd} className="add-user-btn" style={{ display:"flex", alignItems:"center", gap:"8px", padding:"11px 22px", background:"linear-gradient(135deg,#2563eb,#1d4ed8)", color:"#fff", border:"none", borderRadius:"12px", fontWeight:"600", cursor:"pointer", fontSize:"14px", boxShadow:"0 4px 14px rgba(37,99,235,0.35)", transition:"all 0.2s" }}>
      ...
      {/* Add/Edit Modal */}
      {showModal && (
        <div style={{ position:"fixed", inset:0, background:"rgba(15,23,42,0.5)", backdropFilter:"blur(6px)", display:"flex", alignItems:"center", justifyContent:"center", zIndex:1000, padding:"20px", boxSizing:"border-box" }}>
      ...
      {deleteConfirm && (
        <div style={{ position:"fixed", inset:0, background:"rgba(15,23,42,0.5)", backdropFilter:"blur(6px)", display:"flex", alignItems:"center", justifyContent:"center", zIndex:1000, padding:"20px", boxSizing:"border-box" }}>
          <div style={{ background:"white", borderRadius:"20px", padding:"32px", width:"400px", maxWidth:"100%", boxShadow:"0 25px 60px rgba(0,0,0,0.2)", textAlign:"center", boxSizing:"border-box" }}>
